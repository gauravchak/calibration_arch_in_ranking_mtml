import unittest
import torch
from src.prediction_buckets_calibration import PredictionBucketsCalibration


class TestPredictionBucketsCalibration(unittest.TestCase):
    def test_multi_task_estimator(self):
        ...
        model: PredictionBucketsCalibration = PredictionBucketsCalibration(
